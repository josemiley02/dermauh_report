...
\begin{itemize}
    ...
    \item \textbf{Capítulo III. Implementación:} Se describen las tecnologías utilizadas (Django, React, PostgreSQL), la integración de los modelos de IA y procesamiento de imágenes, y las decisiones de implementación más relevantes.
